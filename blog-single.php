                        ...
                        <div class="rs-header-rightside">
                            <div class="main-menu hidden-md">
                                <ul class="nav-menu">
                                    ...
                                    <li class="has-clid relative">
                                        <a href="blog-standard.html" class="active">
                                            <cite class="rs_item_wrap">
                                                Blog
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="rs-blog-single-page__content mt-40">
                        ...
                        <p class="mt-20">Podcasting operational change management inside of workflows to establish a framework. Taking seamless key performance indicators offline to maximise the long tail.</p>
                        ...
                        <div class="row mb-20">
                            <div class="col-lg-6">
                                <div class="rs-thumb mt-20">
                                    <img style="border-radius: 10px;" src="assets/images/blog/blog-single-thumb-1.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 mt-20">
                                <div class="rs-thumb">
                                    <img style="border-radius: 10px;" src="assets/images/blog/blog-single-thumb-2.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <ul>
                            <li><i class="ri-share-forward-fill"></i> Everything in your industry that happens text with their software passage</li>
                            <li><i class="ri-share-forward-fill"></i> Distribution patterns may not be as critical the text with their software</li>
                            <li><i class="ri-share-forward-fill"></i> Analysis is part of good management history of lorem ipsum the text with their</li>
                        </ul>
                        <div class="rs-form">
                ...
                <div class="col-lg-4">
                    <div class="rs-blog-standard-page__sidebar mt-40">
                        ...
                        <div class="rs-blog-category rs-blog-common mt-40">
                            ...
                            <ul>
                                <li><a href="blog-single.html">Application <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="blog-single.html">Cyber <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="blog-single.html">Design <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="blog-single.html">Digital <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="blog-single.html">Software <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="blog-single.html">Technology <i class="ri-arrow-right-fill"></i></a></li>
                            </ul>
                        </div>
                        <div class="rs-blog-sidebar-post rs-blog-common mt-40">
                            ...
                            <div class="rs-blog-sidebar-item mb-25">
                                <div class="rs-thumb">
                                    <a href="blog-single.html"><img src="assets/images/blog/side-blog-1.jpg" alt=""></a>
                                </div>
                                <div class="rs-content">
                                    <h5 class="title"><a href="blog-single.html">10 reliable sources to learn about it solution</a></h5>
                                    <span><i class="ri-calendar-line"></i> March 21, 2023 </span>
                                </div>
                            </div>
                            <div class="rs-blog-sidebar-item mb-25">
                                <div class="rs-thumb">
                                    <a href="blog-single.html"><img src="assets/images/blog/side-blog-2.png" alt=""></a>
                                </div>
                                <div class="rs-content">
                                    <h5 class="title"><a href="blog-single.html"> How do you become a graphic designer? </a></h5>
                                    <span><i class="ri-calendar-line"></i> March 21, 2023 </span>
                                </div>
                            </div>
                            <div class="rs-blog-sidebar-item mb-25">
                                <div class="rs-thumb">
                                    <a href="blog-single.html"><img src="assets/images/blog/side-blog-3.jpg" alt=""></a>
                                </div>
                                <div class="rs-content">
                                    <h5 class="title"><a href="blog-single.html">Simple guidance for you in web development</a></h5>
                                    <span><i class="ri-calendar-line"></i> March 21, 2023 </span>
                                </div>
                            </div>
                            <div class="rs-blog-sidebar-item mb-25">
                                <div class="rs-thumb">
                                    <a href="blog-single.html"><img src="assets/images/blog/side-blog-4.jpg" alt=""></a>
                                </div>
                                <div class="rs-content">
                                    <h5 class="title"><a href="blog-single.html">Techzen App Development Complete Guide </a></h5>
                                    <span><i class="ri-calendar-line"></i> March 21, 2023 </span>
                                </div>
                            </div>
                            <div class="rs-blog-sidebar-item">
                                <div class="rs-thumb">
                                    <a href="blog-single.html"><img src="assets/images/blog/side-blog-5.jpg" alt=""></a>
                                </div>
                                <div class="rs-content">
                                    <h5 class="title"><a href="blog-single.html"> Tips to help you build your social media </a></h5>
                                    <span><i class="ri-calendar-line"></i> March 21, 2023 </span>
                                </div>
                            </div>
                        </div>
