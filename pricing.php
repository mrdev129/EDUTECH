...
<body class="pricing-page">
                ...
                <div class="col-lg-12">
                    <div class="rs-page-banner__content">
                        ...
                        <ul>
                            ...
                            <li><i class="ri-arrow-right-fill"></i> Pricing</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!--======== Pricing Grid Start ========-->
    <section class="rs-pricing-grid  pt-125 pb-120">
        <div class="container">
    ...
    <!--======== Pricing Contact Start ========-->
    <div class="rs-pricing-contact pt-90 pb-90">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="rs-pricing-contact__content">
                        <h4 class="title">Let’s create big stories together.</h4>
                        <p>Mobile is in our nerves. We don’t just build apps, we create brand Choosing us will be your best decision.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="rs-pricing-contact__info">
                        <div class="info-box">
                            <div class="rs-icon">
                        ...
                        <div class="info-box mt-20">
                            <div class="rs-icon">
                                <img src="assets/images/pricing/email_icon_img.png" alt="">
                            </div>
                            <div class="rs-content">
                                <h4 class="title">Email Us</h4>
                                <a href="tel:info@yourdomail.com">info@yourdomail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!--======== Pricing Contact Ends ========-->

    <!--======== Pricing Testimonial Start ========-->
    <section class="rs-testimonial rs-pricing-testimonial mt-110 pb-100 ">
        <div class="container">
            <div class="row">
