...
<div class="stream-content">
    ...
    <div class="course-image">
        <img id="courseImg" src="assets/images/courses/software-dev.png" alt="BCA Software Development">
    </div>
    ...
    <p id="courseDesc" class="course-description">
        Focuses on building robust desktop and enterprise applications using modern programming languages, software testing methodologies, and agile development cycles.
    </p>
...
<div class="stream-sidebar">
    ...
    <h4 class="sidebar-title">BCA Specializations</h4>

    <ul class="course-list">
        <li class="active" onclick="changeCourse('software', this)">Software Development</li>
        <li onclick="changeCourse('analytics', this)">Data Analytics</li>
        <li onclick="changeCourse('cyber', this)">Cyber Security</li>
        <li onclick="changeCourse('cloud', this)">Cloud Computing</li>
        <li onclick="changeCourse('web', this)">Web Dev</li>
    </ul>

    <a href="javascript:void(0);" id="openEnquire" class="enquiry-btn">Enquiry Now</a>
...
<script>
        const bcaCourses = {
            software: {
                img: "assets/images/courses/software-dev.png",
                title: "BCA in Software Development",
                desc: "Focuses on building robust desktop and enterprise applications using modern programming languages, software testing methodologies, and agile development cycles."
            },
            analytics: {
                img: "assets/images/courses/data-analytics.png",
                title: "BCA in Data Analytics",
                desc: "Learn to interpret complex data sets, create visualizations, and provide actionable business insights using tools like Python, R, and Tableau."
            },
            cyber: {
                img: "assets/images/courses/cyber-security.png",
                title: "BCA in Cyber Security",
                desc: "Covers network security, ethical hacking, digital forensics, and protocols to protect information systems from cyber threats."
            },
            cloud: {
                img: "assets/images/courses/cloud-computing.png",
                title: "BCA in Cloud Computing",
                desc: "Focuses on cloud architecture, virtualization, and managing scalable services on platforms like AWS, Azure, and Google Cloud."
            },
            web: {
                img: "assets/images/courses/web-dev.png",
                title: "BCA in Web Dev",
                desc: "Master front-end and back-end technologies to create responsive, high-performance websites and modern web-based applications."
            }
        };

        function changeCourse(courseKey, element) {
            const course = bcaCourses[courseKey];
            if (!course) return;
