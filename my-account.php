                ...
                <div class="col-lg-12">
                    <div class="rs-page-banner__content">
                        ...
                        <ul>
                            ...
                            <li><i class="ri-arrow-right-fill"></i> My Account</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 md-mb-50">
                    ...
                    <div class="rs-login">
                        <div class="form-group mb-30">
                            ...
                            <input id="fname" name="fname" class="form-control-mod" type="email" required="">
                            <label class="mt-20">Password <span>*</span></label>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="rs-login">
                        <div class="form-group">
                            ...
                            <input id="gname" name="type" class="form-control-mod" type="email" required="">
                        </div>
