...
<body class="serivice-page-1">
                            ...
                            <div class="main-menu hidden-md">
                                <ul class="nav-menu">
                                    ...
                                    <li class="has-clid relative">
                                        ...
                                        <ul class="sub-menu">
                                            <li>
                                                <a class="active" href="service-1.html">Service Style 01</a>
                                            </li>
                                            <li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="rs-featured-2__item">
                        <div class="rs-thumb">
                            <img src="assets/images/featured/featured-thumb-5.png" alt="">
                        </div>
                        <div class="rs-content">
                            <div class="rs-icon">
                                <img src="assets/images/featured/features-icon-1.png" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="rs-featured-2__item">
                        <div class="rs-thumb">
                            <img src="assets/images/featured/featured-thumb-6.png" alt="">
                        </div>
                        <div class="rs-content">
                            <div class="rs-icon">
                                <img src="assets/images/featured/features-icon-2.png" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="rs-featured-2__item">
                        <div class="rs-thumb">
                            <img src="assets/images/featured/featured-thumb-7.png" alt="">
                        </div>
                        <div class="rs-content">
                            <div class="rs-icon">
                                <img src="assets/images/featured/features-icon-3.png" alt="">
    ...
    <section class="rs-counter-2 rs-service-counter pb-125">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="rs-counter-2__item item-4">
                        ...
                        <div class="rs-counter-2__content">
                            <h4 class="title"><span class="rs-count">1200</span> +</h4>
