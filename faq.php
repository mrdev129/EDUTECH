...
<body class="faq-page">
                ...
                <div class="col-lg-12">
                    <div class="rs-page-banner__content">
                        ...
                        <ul>
                            ...
                            <li><i class="ri-arrow-right-fill"></i> Faq</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="rs-faq-page__box">
                        <div class="rs-faq__wrapper">
                            ...
                            <div class="accordion">
                                <div class="accordion_tab">
                                    04. How to soft launch your business?
                                    <div class="accordion_arrow">
                                        <i class="ri-add-fill"></i>
                                    </div>
                                </div>
                            ...
                            <div class="accordion">
                                <div class="accordion_tab">
                                    05. How to soft launch your business?
                                    <div class="accordion_arrow">
                                        <i class="ri-add-fill"></i>
                                    </div>
                                </div>
    ...
    <section class="rs-contact rs-faq-contact pt-110 pb-100">
        ...
        <div class="rs-contact__thumb">
            <img src="assets/images/contact/contact-man.png" alt="">
        ...
        <div class="rs-contact__shape2">
            <img src="assets/images/contact/contact_arrow_right.png" alt="">
        </div>
    </section>
    <!--======== Faq Contact Ends ========-->
