                                    ...
                                    <li class="has-clid relative">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="has-clid">
                                                ...
                                                <ul class="sub-menu">
                                                    <li>
                                                        <a class="active" href="service-details.html">Service Details Style 01</a>
                                                    </li>
                                                    <li>
                ...
                <div class="col-lg-12">
                    <div class="rs-page-banner__content">
                        ...
                        <ul>
                            ...
                            <li><i class="ri-arrow-right-fill"></i> Services Details</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="rs-service-details__content">
                        <div class="rs-thumb">
                            <img src="assets/images/service/service-details-thumb-1.jpg" alt="">
                        </div>
                        <div class="rs-content">
                            ...
                            <h3 class="title mt-30">Working challenge</h3>
                            <div class="rs-service-list-box">
                                <div class="rs-thumb">
                                    <img src="assets/images/service/service-detail-small-img.jpg" alt="">
                                </div>
                                <div class="rs-list">
                                    <ul>
                                        ...
                                        <li><i class="ri-share-forward-fill"></i> Predominate extensible testing procedures.</li>
                                        <li><i class="ri-share-forward-fill"></i> Phosfluorescently engage worldwide.</li>
                                    </ul>
                                </div>
                            </div>
                            <h3 class="title pt-40 pb-15">Benefits with our service</h3>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="rs-service-benefit">
                                        <h4 class="title">Flexible Solutions</h4>
                                        <p>Proactively envisioned multimedia based expertise and cross-media growth.</p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="rs-service-benefit">
                                        <h4 class="title">24/7 Unlimited Support</h4>
                                        <p>Collaboratively administrate empowered markets via plug-and-play networks.</p>
                                    </div>
                                </div>
                            </div>
                            <h3 class="title pt-40 pb-15">Questions about service</h3>
                                ...
                                <div class="accordion active">
                                    ...
                                    <div class="accordion_content">
                                        <div class="accordion_item">
                                            <p>Technology is at the forefront of innovation and progress, enabling us to tackle some of the world’s biggest challenges and improve the quality of life for people around the globe. </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion">
                ...
                <div class="col-lg-4">
                    <div class="rs-service-details__sidebar">
                        <div class="category-box sidebar-common">
                            ...
                            <ul>
                                <li><a href="service-details.html"><span>IT Solutions</span> <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="service-details.html"><span>Cyber Security</span> <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="service-details.html"><span>Cloud Services</span> <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="service-details.html"><span>Digital Strategy</span> <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="service-details.html"><span>SEO Optimization</span> <i class="ri-arrow-right-fill"></i></a></li>
                                <li><a href="service-details.html"><span>Brand Identity</span> <i class="ri-arrow-right-fill"></i></a></li>
                            </ul>
                        </div>
                        <div class="solution-box sidebar-common mt-40">
                            <h4 class="title">Do you have a Technical Issues?</h4>
                            <a class="main-btn" href="contact.html">Find Solution <i class="ri-arrow-right-fill"></i></a>
                        </div>
                        <div class="download-box sidebar-common mt-40">
                            ...
                            <ul>
                                <li><a href="#"><span>Download PDF</span> <i class="ri-download-cloud-2-fill"></i></a></li>
