                ...
                <div class="col-lg-12">
                    <div class="rs-page-banner__content">
                        ...
                        <ul>
                            ...
                            <li><i class="ri-arrow-right-fill"></i> Cart</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="cart-wrap">
                <form>
                    <table class="cart-table">
                        ...
                        <tbody>
                            <tr>
                                <td class="product-remove"><a href="#"><i class="ri-close-line"></i></a></td>
                                <td class="product-thumbnail"><a href="#"><img src="assets/images/shop/shop-3.jpg" alt=""></a></td>
                                <td class="product-name"><a href="#">Bluetooth Speaker</a></td>
                            ...
                            <tr>
                                <td class="product-remove"><a href="#"><i class="ri-close-line"></i></a></td>
                                <td class="product-thumbnail"><a href="#"><img src="assets/images/shop/shop-5.jpg" alt=""></a></td>
                                <td class="product-name"><a href="#">Purifier Sharp</a></td>
                                <td class="product-price"><span>$</span>30.00</td>
                                <td class="product-quantity"><input type="text" class="input-text" value="1" pattern="[0-9]*"></td>
                                <td class="subtotal"><span class="amount"><span class="symbol">$</span>30.00</span></td>
                            </tr>
                            <tr>
                                <td colspan="6" class="action text-right">
                                    <div class="coupon">
                                        ...
                                        <button class="main-btn cart" type="submit">Apply Coupon</button>
                                    </div>
                                    <div class="update-cart">
                                        <button class="main-btn cart" type="submit">Update cart</button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="cart-collaterals pt-70 md-pt-50">
                    <div class="cart-totals">
                        <h5 class="title mb-10">Cart totals</h5>
                        ...
                        <div class="wc-proceed-to-checkout">
                            <button class="main-btn cart" type="submit"> Proceed to checkout</button>
                        </div>
                    </div>
                </div>
            </div>
