...
<body class="shop-page">
                                    ...
                                    <li class="has-clid relative">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="has-clid">
                                                ...
                                                <ul class="sub-menu">
                                                    <li>
                                                        <a class="active" href="shop.html">Product</a>
                                                    </li>
                                                    <li>
                ...
                <div class="col-lg-12">
                    <div class="rs-page-banner__content">
                        ...
                        <ul>
                            ...
                            <li><i class="ri-arrow-right-fill"></i> Product</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!--======== Shop Page Banner Ends ========-->

    <!--======== Shop Page Start ========-->
    <section class="rs-shop-page pt-90 pb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="rs-shop-page__box mt-30">
                        <div class="shop-page-topbar">
                            <p> Showing 1–9 of 12 results</p>
                            <select name="cars" id="cars">
                                <option selected="selected" value="volvo">Default sorting</option>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="rs-shop-item mt-40">
                                    <div class="rs-thumb">
                                        <a href="product-single.html">
                                            <img src="assets/images/shop/shop-1.jpg" alt="">
                                            <span class="rs-add-cart">Add To Cart</span>
                                        </a>
                                    </div>
                                    <div class="rs-content">
                                        <a href="product-single.html">Air Purifier</a>
                                        <h5 class="rs-price">$30.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="rs-shop-item mt-40">
                                    ...
                                    <div class="rs-content">
                                        <a href="product-single.html">Black Watch</a>
                                        <h5 class="rs-price">$40.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="rs-shop-item mt-40">
                                    ...
                                    <div class="rs-content">
                                        <a href="product-single.html">Bluetooth Speaker</a>
                                        <h5 class="rs-price">$42.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="rs-shop-item mt-40">
                                    ...
                                    <div class="rs-content">
                                        <a href="product-single.html">Instax Camera</a>
                                        <h5 class="rs-price">$70.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="rs-shop-item mt-40">
                                    ...
                                    <div class="rs-content">
                                        <a href="product-single.html">Purifier Sharp</a>
                                        <h5 class="rs-price">$22.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="rs-shop-item mt-40">
                                    ...
                                    <div class="rs-content">
                                        <a href="product-single.html">Slim Headphone</a>
                                        <h5 class="rs-price">$29.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="rs-shop-item mt-40">
                                    <div class="rs-thumb">
                                        <a href="product-single.html">
                                            <img src="assets/images/shop/shop-7.jpg" alt="">
                                            <span class="rs-add-cart">Add To Cart</span>
                                        </a>
                                    </div>
                                    <div class="rs-content">
                                        <a href="product-single.html">Smart Phone</a>
                                        <h5 class="rs-price">$99.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="rs-shop-item mt-40">
                                    <div class="rs-thumb">
                                        <a href="product-single.html">
                                            <img src="assets/images/shop/shop-8.jpg" alt="">
                                            <span class="rs-add-cart">Add To Cart</span>
                                        </a>
                                    </div>
                                    <div class="rs-content">
                                        <a href="product-single.html">Smart Watch</a>
                                        <h5 class="rs-price">$25.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="rs-shop-item mt-40">
                                    <div class="rs-thumb">
                                        <a href="product-single.html">
                                            <img src="assets/images/shop/shop-9.jpg" alt="">
                                            <span class="rs-add-cart">Add To Cart</span>
                                        </a>
                                    </div>
                                    <div class="rs-content">
                                        <a href="product-single.html">Sound Speaker</a>
                                        <h5 class="rs-price">$45.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                ...
                <div class="col-lg-4">
                    <div class="rs-shop-page__sidebar mt-30">
                        <div class="rs-shop-category">
                            <h4 class="title">Product categories</h4>
                            <ul>
                                <li><a href="product-single.html">Accessories</a></li>
                                <li><a href="product-single.html">Digital Gadgets</a></li>
                                <li><a href="product-single.html">Smart Laptop</a></li>
                                <li><a href="product-single.html">Smart Watch</a></li>
                                <li><a href="product-single.html">Technology</a></li>
                            </ul>
                        </div>
                        <div class="rs-shop-filter mt-40">
                            <h4 class="title">Filter by price</h4>
                            <div class="price-range-block">
                                <div id="slider-range" class="price-filter-range"></div>

                                <div style="margin-bottom:10px; text-align: right; margin-top: 30px;">
                                    <span style="font-weight: 500; margin-right: 10px;">Price:</span>
                                    <input type="number" min="0" max="190" oninput="validity.valid||(value='0');" id="min_price" class="price-range-field">
                                    <input type="number" min="0" max="200" oninput="validity.valid||(value='200');" id="max_price" class="price-range-field">
                                </div>
