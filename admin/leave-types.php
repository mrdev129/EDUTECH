...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionName" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Leave Types
                    </label>
                    <input type="text" class="form-control" id="sectionName" placeholder="Enter Fees Type name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
               <div class="col-sm-12">
                <div class="">
                    <label for="sectionNameTwo" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees Type
                    </label>
                    <input type="text" class="form-control" id="sectionNameTwo" placeholder="Enter Fees Type name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionStatusTwoo" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Status
                    </label>
                    <select id="sectionStatusTwoo" class="form-control form-select">
                        <option value="Select a subject" selected disabled>Select Status</option>
                        <option value="Active">Active</option>
                        <option value="Inactive">Inactive</option>
                    </select>
