  ...
  <div class="row align-items-center justify-content-between">
    ...
    <div class="dashboard-main-body">
        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                <h1 class="fw-semibold mb-4 h6 text-primary-light">Income Head List</h1>
                <div class="">
                    <a href="index.php" class="text-secondary-light hover-text-primary hover-underline">Dashboard </a>
                    <span class="text-secondary-light">/ Income Head List</span>
                </div>
            </div>
...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Add Income Head </h5>
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="headName" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Head Name
                    </label>
                    <input type="text" class="form-control" id="headName" placeholder="Enter Head Name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="description" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Description
                    </label>
...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Edit Income Head </h5>
    ...
    <form action="#" class="d-flex flex-column p-20">
         <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="headNameEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Head Name
                    </label>
                    <input type="text" class="form-control" id="headNameEdit" placeholder="Enter Head Name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="descriptionEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Description
                    </label>
