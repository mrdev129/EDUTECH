                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-lg-end border p-12">
                                                ...
                                                <li>
                                                    <button
                                                        class="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2 py-6"
                                                        type="button" data-bs-toggle="modal" data-bs-target="#exampleModalDelete">
                                                        <i class="ri-delete-bin-6-line"></i>
                                                        Delete
                                                    </button>
                                                </li>
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionName" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Class
                        Name
                    </label>
                    <input type="text" class="form-control" id="sectionName" placeholder="Enter Class name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="selectSectionTwo" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Section
                    </label>
                     <select id="selectSectionTwo" class="form-control form-select">
                        <option value="Select a class" selected disabled>Select Section</option>
            ...
            <div class="col-sm-12">
                <div class="">
                    ...
                    <select id="sectionStatus" class="form-control form-select">
                        <option value="Select a class" selected disabled>Select Status</option>
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionNameEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Class
                        Name
                    </label>
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="selectSectionEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Section
                    </label>
                     <select id="selectSectionEdit" class="form-control form-select">
                        <option value="Select a class" selected disabled>Select Section</option>
                        <option value="A">A</option>
                        <option value="B">B</option>
                        <option value="C">C</option>
