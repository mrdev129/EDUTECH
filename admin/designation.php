  ...
  <div class="row align-items-center justify-content-between">
    ...
    <div class="dashboard-main-body">
        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                <h1 class="fw-semibold mb-4 h6 text-primary-light">Designation </h1>
                <div class="">
                    ...
                    <a href="employee-list.php" class="text-secondary-light hover-text-primary hover-underline "> /
                        HRM</a>
                    <span class="text-secondary-light">/ Designation</span>
                </div>
            </div>
                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length='10'>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Principal</td>
                                    <td>Head of the entire school/institution</td>
                                    <td>
                                        <div class="btn-group">
                                ...
                                <tr>
                                    ...
                                    <td>Assists the principal and oversees daily operations</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                                data-bs-toggle="dropdown" data-bs-display="static"
                                ...
                                <tr>
                                    ...
                                    <td>Head Teacher</td>
                                    <td>Leads a department or specific academic section</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                                data-bs-toggle="dropdown" data-bs-display="static"
                                ...
                                <tr>
                                    ...
                                    <td>Experienced teacher responsible for mentoring junior staff</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                                data-bs-toggle="dropdown" data-bs-display="static"
                                ...
                                <tr>
                                    ...
                                    <td>Teaches a specific subject and manages lesson plans</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                                data-bs-toggle="dropdown" data-bs-display="static"
                                ...
                                <tr>
                                    ...
                                    <td>Class Teacher</td>
                                    <td>Responsible for overall management of a specific class</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                                data-bs-toggle="dropdown" data-bs-display="static"
                                ...
                                <tr>
                                    ...
                                    <td>Accountant</td>
                                    <td>Manages financial records, budgeting, and salaries</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                                data-bs-toggle="dropdown" data-bs-display="static"
                                ...
                                <tr>
                                    ...
                                    <td>Supports administrative operations and documentation</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                                data-bs-toggle="dropdown" data-bs-display="static"
                                ...
                                <tr>
                                    ...
                                    <td>Librarian</td>
                                    <td>Maintains the school library and manages book records</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                                data-bs-toggle="dropdown" data-bs-display="static"
                                ...
                                <tr>
                                    ...
                                    <td>Peon</td>
                                    <td>Assists staff with various daily duties and logistics</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                                data-bs-toggle="dropdown" data-bs-display="static"
...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Add Designation</h5>
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="designationName"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Designation Name
                    </label>
                    <input type="text" class="form-control" id="designationName" placeholder="Enter designation name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Edit Designation </h5>
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="designationNameEdit"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Designation Name
                    </label>
                    <input type="text" class="form-control" id="designationNameEdit"
