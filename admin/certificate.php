        ...
        <div class="row g-3">
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <select id="seelctClass" class="form-control form-select">
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <select id="seelctSection" class="form-control form-select">
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <select id="seelctStudent" class="form-control form-select">
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="date" class="form-control" id="seelctDate">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="footerLeftText" placeholder="Enter Footer Left Text">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="footerRightText" placeholder="Enter Footer Right Text">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
        ...
        <div class="row g-3">
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="certificateNameEdit"
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <select id="seelctClassEdit" class="form-control form-select">
                        <option value="Select a Class" selected disabled>Select Class</option>
                        <option value="One">One</option>
                        <option value="Two">Two</option>
                        <option value="Three">Three</option>
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <select id="seelctSectionEdit" class="form-control form-select">
                        <option value="Select a Section" selected disabled>Select Section</option>
                        <option value="A">A</option>
                        <option value="B">B</option>
                        <option value="C">C</option>
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <select id="seelctStudentEdit" class="form-control form-select">
                        <option value="Select a Student" selected disabled>Select Student</option>
                        <option value="Male">Male</option>
                        <option value="Female">Female</option>
                    </select>
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="date" class="form-control" id="seelctDateEdit">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="footerLeftTextEdit"
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="footerRightTextEdit"
