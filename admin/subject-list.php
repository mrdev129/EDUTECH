...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionName" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Subjects
                        Name
                    </label>
                    <input type="text" class="form-control" id="sectionName" placeholder="Enter subjects name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="subjectCode" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Subjects
                        Code
                    </label>
                    <input type="text" class="form-control" id="subjectCode" placeholder="Enter subjects code">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
               ...
               <div class="col-sm-12">
                <div class="">
                    <label for="subjectCodeTwoEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Subjects
                        Code
                    </label>
                    <input type="text" class="form-control" id="subjectCodeTwoEdit" placeholder="Enter subjects code">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
