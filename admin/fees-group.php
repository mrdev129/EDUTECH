  ...
  <div class="row align-items-center justify-content-between">
    ...
    <div class="dashboard-main-body">
        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                <h1 class="fw-semibold mb-4 h6 text-primary-light">Fees Group </h1>
                <div class="">
                    <a href="index.php" class="text-secondary-light hover-text-primary hover-underline">Dashboard </a>
                    <span class="text-secondary-light">/ Fees Group </span>
                </div>
            </div>
                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length='10'>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Class 1 (A) Fees</td>
                                    <td>May month fees, Admission fees, Exam fees</td>
                                    <td><span
...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Add New Class Room</h5>
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionName" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Group
                        Name
                    </label>
                    <input type="text" class="form-control" id="sectionName" placeholder="Enter Group Name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="feesType" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees
                        Type</label>
                    <select id="feesType" class="form-control form-select">
                        <option value="Select fees type" selected disabled>Select fees type</option>
...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Edit Class Room</h5>
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
             <div class="col-sm-12">
                <div class="">
                    <label for="sectionNameEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Group
                        Name
                    </label>
                    <input type="text" class="form-control" id="sectionNameEdit" placeholder="Enter Group Name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="feesTypeEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees
                        Type</label>
                    <select id="feesTypeEdit" class="form-control form-select">
                        <option value="Select fees type" selected disabled>Select fees type</option>
                        <option value="May month fees">May month fees</option>
                        <option value="Admission fees">Admission fees</option>
                        <option value="Exam fees">Exam fees</option>
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionStatusTwoHere" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Status
                    </label>
                    <select id="sectionStatusTwoHere" class="form-control form-select">
                        <option value="Select a subject" selected disabled>Select Status</option>
                        <option value="Active">Active</option>
                        <option value="Inactive">Inactive</option>
                    </select>
