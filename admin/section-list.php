        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                ...
                <div class="">
                    ...
                    <span class="text-secondary-light">/ Section Details</span>
                </div>
            </div>
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionName" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Section
                        Name
                    </label>
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionNameEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Section
                        Name
                    </label>
