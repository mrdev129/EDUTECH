  ...
  <div class="row align-items-center justify-content-between">
    ...
    <div class="dashboard-main-body">
        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                <h1 class="fw-semibold mb-4 h6 text-primary-light">Languages </h1>
                <div class="">
                    ...
                    <a href="employee-list.php" class="text-secondary-light hover-text-primary hover-underline "> /
                        Settings</a>
                    <span class="text-secondary-light">/ Languages</span>
                </div>
            </div>
...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Add Language</h5>
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="languageName"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Language Name
                    </label>
                    <input type="text" class="form-control" id="languageName" placeholder="Enter Language Name">
                </div>
            </div>
            <div class="col-12">
...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Edit Language </h5>
        ...
        <div class="row g-3">
             <div class="col-sm-12">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="languageNameEdit" placeholder="Enter Language Name">
                </div>
            </div>
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-center gap-3 mt-8">
