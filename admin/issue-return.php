  ...
  <div class="row align-items-center justify-content-between">
    ...
    <div class="dashboard-main-body">
        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                <h1 class="fw-semibold mb-4 h6 text-primary-light">Issue Return </h1>
                <div class="">
                    <a href="index.php" class="text-secondary-light hover-text-primary hover-underline">Dashboard </a>
                    <span class="text-secondary-light">/ Issue Return </span>
                </div>
            </div>
        ...
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="bookNameEdit" placeholder="Enter Book Name">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="publisherEdit" placeholder="Enter Publisher">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="authorEdit" placeholder="Enter Author">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    <label for="numberEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Number
                    </label>
                    <input type="number" class="form-control" id="numberEdit" placeholder="Enter Number">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="subjectEdit" placeholder="Enter Subject">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="rackNoEdit" placeholder="Enter Rack No">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="enterQtyEdit" placeholder="Enter Qty">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="availableEdit" placeholder="Enter Available">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="priceEdit" placeholder="Enter Price">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="date" class="form-control" id="postDateEdit">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <select id="statusEdit" class="form-control form-select">
...
<!-- Modal Return Event start -->
<div class="modal fade" id="exampleModalReturn" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog modal-dialog-centered max-w-340-px">
        <div class="modal-content radius-16 bg-base">
            <div class="modal-body pt-32 px-36 pb-24 text-center">
                ...
                <h6 class="text-lg fw-semibold text-primary-light mb-0">Are your sure you want to Return this book!
                </h6>
