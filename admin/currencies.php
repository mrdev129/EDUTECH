  ...
  <div class="row align-items-center justify-content-between">
    ...
    <div class="dashboard-main-body">
        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                <h1 class="fw-semibold mb-4 h6 text-primary-light">Currencies </h1>
                <div class="">
                    ...
                    <a href="employee-list.php" class="text-secondary-light hover-text-primary hover-underline "> /
                        Settings</a>
                    <span class="text-secondary-light">/ Currencies</span>
                </div>
            </div>
...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Add Currencies</h5>
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="currenciesName"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Currencies Name
                    </label>
                    <input type="text" class="form-control" id="currenciesName" placeholder="Enter Currencies Name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="symbol" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Symbol
                    </label>
                    <textarea class="form-control" id="symbol" placeholder="Enter Symbol"></textarea>
                </div>
            </div>
            <div class="col-12">
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="currenciesNameEdit"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Currencies Name
                    </label>
                    <input type="text" class="form-control" id="currenciesNameEdit" placeholder="Enter Currencies Name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="symbolEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Symbol
                    </label>
                    <textarea class="form-control" id="symbolEdit" placeholder="Enter Symbol"></textarea>
                </div>
            </div>
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-center gap-3 mt-8">
