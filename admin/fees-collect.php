                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length='10'>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="bg-success-100 text-success-600 px-16 py-2 radius-4 fw-medium text-sm">Paid</span>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-lg-end border p-12">
                                                <li>
                                                    <button type="button"
                                                        class="edit-sidebar-btn dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2 py-6" data-bs-toggle="modal" data-bs-target="#payslipModal">
                                ...
                                <tr>
                                    ...
                                    <td>10 May 2025</td>
                                    <td><span
                                            class="bg-warning-100 text-warning-600 px-16 py-2 radius-4 fw-medium text-sm">Partial</span>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                ...
                                <tr>
                                    ...
                                    <td>08 May 2025</td>
                                    <td><span
                                            class="bg-danger-100 text-danger-600 px-16 py-2 radius-4 fw-medium text-sm">Unpaid</span>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="text-primary-light text-xl"
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/thumbs/avatar-img7.png" alt="Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1">Darlene Robertson</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>11</td>
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-6">
                <div class="">
                    <label for="className" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Class
                    </label>
                    <select class="form-control form-select" id="className">
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="rollNo" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Roll No
                    </label>
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="collectDate" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Date
                    </label>
            ...
            <div class="col-sm-6">
                <div class="">
                    <div class="d-flex align-items-center justify-content-between gap-4">
                        <label for="collectAmount" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Amount
                        </label>
                        <span class="text-sm fw-semibold text-warning-600">Due: 2000</span>
                    </div>
                    <input type="text" class="form-control" id="collectAmount" placeholder="$1500">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    <label for="colDiscount" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount
                    </label>
                    <select class="form-control form-select" id="colDiscount">
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="noteType" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Note
                    </label>
                    <textarea class="form-control" id="noteType" placeholder="Enter note..."></textarea>
                </div>
            </div>
            <div class="col-12">
            ...
            <div class="modal-body p-24">
                ...
                <div class="d-flex align-items-center justify-content-between gap-20 flex-wrap mt-24 ">
                    <div class="d-flex flex-column">
                        <div class="text-sm fw-medium d-flex">
                            <span class="text-primary-light w-110-px text-start">Student Name</span>
                            <span class="text-primary-light">: Jon Deve</span>
                        </div>
                        <div class="text-sm fw-medium d-flex">
                            <span class="text-primary-light w-110-px text-start">Class</span>
                            <span class="text-primary-light">: 5 (A)</span>
                        </div>
                        <div class="text-sm fw-medium d-flex">
                            <span class="text-primary-light w-110-px text-start">Roll No.</span>
                            <span class="text-primary-light">: 10</span>
                        </div>
                    </div>
                    <div class="d-flex flex-column">
                        <div class="text-sm fw-medium d-flex">
                            <span class="text-primary-light text-start">Date: 15 Jan 2025</span>
                        </div>
                        <div class="text-sm fw-medium d-flex">
                            <span class="text-primary-light text-start">Collected By: Admin</span>
                        </div>
                        <div class="text-sm fw-medium d-flex">
                            <span class="text-primary-light text-start">Payment By: Bank</span>
                        </div>
                    </div>
                </div>
                <ul class="border mt-24 radius-8 overflow-hidden">
                    <li class="py-10 px-20 d-flex align-items-center justify-content-between gap-20 bg-neutral-50 border-bottom">
                        ...
                        <span class="text-primary-light fw-semibold">Paid</span>
                        <span class="text-primary-light fw-semibold">Balance</span>
                    </li>
                    <li class="py-10 px-20 d-flex align-items-center justify-content-between gap-20 ">
                        <span class="text-primary-light">2500</span>
                        <span class="text-primary-light">$1500</span>
                        <span class="text-primary-light">$500</span>
                    </li>
                </ul>
                <div class="text-center mt-100-px">
                    <h6 class="text-xl mb-4">Thanks</h6>
                    <p class="text-secondary-light text-sm mb-0">This receipt is computer generated hence on signature is required</p>
                </div>
                <div class="text-center mt-100-px">
