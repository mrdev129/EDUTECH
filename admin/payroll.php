                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium">Courtney Henry</h6>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/thumbs/teacher-avatar-img3.png"
                                                alt="Ralph Edwards Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium">Ralph Edwards</h6>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/thumbs/teacher-avatar-img4.png"
                                                alt="Annette Black Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium">Annette Black</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>IT Department</td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/thumbs/teacher-avatar-img6.png"
                                                alt="Jacob Jones Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/thumbs/teacher-avatar-img7.png"
                                                alt="Kathryn Murphy Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium">Kathryn Murphy</h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium">Esther Howard</h6>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/thumbs/teacher-avatar-img9.png"
                                                alt="Floyd Miles Image" class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium">Floyd Miles</h6>
                                            </div>
                                        </div>
                                    </td>
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-6">
                <div class="">
                    <label for="employeeName"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Employee Name
                    </label>
                    <input type="text" class="form-control" id="employeeName" placeholder="Enter Fees Type name">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    <label for="paymentAmount"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Payment Amount ($)
                    </label>
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="month" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Month
                    </label>
                    <select id="month" class="form-control form-select">
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="paymentTypee" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Payment
                        Type
                    </label>
                    <select id="paymentTypee" class="form-control form-select">
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="paymentDate" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Date
                    </label>
            ...
            <div class="col-sm-12">
                <div class="">
                    ...
                    <textarea class="form-control" id="ddescription" placeholder="Enter Description"></textarea>
                </div>
            </div>
            <div class="col-12">
        ...
        <div class="modal-content radius-16 bg-base">
            <div class="modal-body p-24">
                ...
                <ul class="border mt-24 radius-8 overflow-hidden">
                    <li
                        class="py-10 px-20 d-flex align-items-center justify-content-between gap-20 bg-neutral-50 border-bottom">
                ...
                <div class="text-center mt-100-px">
                    ...
                    <p class="text-secondary-light text-sm mb-0">If you need further assistance, please feel free to
                        contact HR at <span class="fw-semibold text-primary-light">Example school</span> </p>
                </div>
                <div class="text-center mt-100-px">
                    <p class="text-secondary-light text-sm mb-0">Made by <span class="fw-semibold">Wowtheme7.</span>
                    </p>
                </div>
            </div>
        </div>
