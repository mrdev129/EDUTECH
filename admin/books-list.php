...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="number" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Number
                    </label>
            ...
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="rackNo" placeholder="Enter Rack No">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="enterQty" placeholder="Enter Qty">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
                    ...
                    <input type="text" class="form-control" id="available" placeholder="Enter Available">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="">
