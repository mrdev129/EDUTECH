...
<body>
  ...
  <ul class="sidebar-submenu">
    ...
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            <h1 class="fw-semibold mb-4 h6 text-primary-light">View Contact Message</h1>
            <div>
                <a href="index.php" class="text-secondary-light hover-text-primary hover-underline">
                    Dashboard
                </a>
                <span class="text-secondary-light"> / Contact Message</span>
            </div>
        </div>
        ...
        <div>
            <a href="responses.php"
               class="btn bg-neutral-200 text-dark px-16 py-6 radius-6">
        ...
        <div class="card-body p-24">
            ...
            <div class="row mb-24">
                ...
                <div class="col-md-6 mb-16">
                    ...
                    <div class="border rounded p-12 bg-neutral-50">
                ...
                <div class="col-md-6 mb-16">
                    <label class="fw-semibold">Submitted On</label>
                    <div class="border rounded p-12 bg-neutral-50">
            ...
            <div class="mb-16">
                ...
                <div class="border rounded p-16 bg-neutral-50" style="min-height:120px;">
            ...
            <div class="d-flex gap-12 mt-20">
                ...
                <a href="add-to-student.php?id=<?= $row['id'] ?>"
                   class="btn bg-success-600 text-white px-20 py-8 radius-6">
                   <i class="ri-user-add-line"></i> Add to List
                </a>

                <a href="mark-read.php?id=<?= $row['id'] ?>"
                   class="btn bg-primary-600 text-white px-20 py-8 radius-6">
                   <i class="ri-mail-open-line"></i> Mark as Read
                </a>

                <a href="delete-response.php?id=<?= $row['id'] ?>"
                   onclick="return confirm('Are you sure you want to delete this response?')"
                   class="btn bg-danger-600 text-white px-20 py-8 radius-6">
