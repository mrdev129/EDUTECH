    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="roleName"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Role Name
                    </label>
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="enterDate"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Date
                    </label>
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            ...
            <div class="col-sm-12">
                <div class="">
                    <label for="enterDateEdit"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Date
                    </label>
                    <input type="date" class="form-control" id="enterDateEdit">
                </div>
            </div>
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-center gap-3 mt-8">
