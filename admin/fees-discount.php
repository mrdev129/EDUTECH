...
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Add New Discount</h5>
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="discountType"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Type</label>
                    <select id="discountType" class="form-control form-select">
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="discountValue"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Value </label>
                    <input type="text" class="form-control" id="discountValue" placeholder="Ex: 10%">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="discountTypeEdit"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Type</label>
                    <select id="discountTypeEdit" class="form-control form-select">
                        <option value="Percentage" selected>Percentage</option>
                        <option value="Percentage">Percentage</option>
                    </select>
                </div>
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="discountValueEdit"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Value </label>
                    <input type="text" class="form-control" id="discountValueEdit" placeholder="Ex: 10%">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionStatusEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Status
                    </label>
