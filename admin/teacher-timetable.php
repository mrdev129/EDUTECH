        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                ...
                <div class="">
                    ...
                    <span class="text-secondary-light">/ Teacher Timetable</span>
                </div>
            </div>
                ...
                <div
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-16">
                        ...
                        <form class="navbar-search dt-search m-0">
                            <input type="text" class="item-search-input dt-input bg-transparent radius-4" name="search" placeholder="Search...">
                            <iconify-icon icon="ion:search-outline" class="icon"></iconify-icon>
                        </form>
                        <div class="dropdown">
                            <button type="button"
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex flex-column gap-16">
                                    <div class="attendance-card border radius-8 overflow-hidden">
                                        <h6
                                            class="text-sm bg-warning-100 text-warning-600 fw-semibold py-10 px-16 text-center mb-0 card-title">
                                            Class: 1 (A)
                                        </h6>
                                    ...
                                    <div class="attendance-card border radius-8 overflow-hidden">
                                        <h6
                                            class="text-sm bg-info-100 text-info-600 fw-semibold py-10 px-16 text-center mb-0 card-title">
                                            Class: 2 (B)
                                        </h6>
                                        <div class="px-10 py-16 d-flex flex-column gap-10">
                                            <div class="d-flex align-items-center gap-8">
                                    ...
                                    <div class="attendance-card border radius-8 overflow-hidden">
                                        <h6
                                            class="text-sm bg-success-100 text-success-600 fw-semibold py-10 px-16 text-center mb-0 card-title">
                                            Class: 3 (A)
                                        </h6>
                                        <div class="px-10 py-16 d-flex flex-column gap-10">
                                            <div class="d-flex align-items-center gap-8">
                                    ...
                                    <div class="attendance-card border radius-8 overflow-hidden">
                                        <h6
                                            class="text-sm bg-danger-100 text-danger-600 fw-semibold py-10 px-16 text-center mb-0 card-title">
                                            Class: 4 (C)
                                        </h6>
                                        <div class="px-10 py-16 d-flex flex-column gap-10">
                                            <div class="d-flex align-items-center gap-8">
                                    ...
                                    <div class="attendance-card border radius-8 overflow-hidden">
                                        <h6
                                            class="text-sm bg-primary-100 text-primary-600 fw-semibold py-10 px-16 text-center mb-0 card-title">
                                            Class: 5 (B)
                                        </h6>
                                        <div class="px-10 py-16 d-flex flex-column gap-10">
                                            <div class="d-flex align-items-center gap-8">
...
<!-- Add New Timetable sidebar start -->
<div
    ...
    <div class="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 class="text-lg mb-0">Add New Timetable</h5>
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-6">
                <div class="">
                    <label for="timetableDay" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Day
                    </label>
                    <select id="timetableDay" class="form-control form-select">
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="timetableSelectTeacher"
                        class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Teacher
                    </label>
                    <select id="timetableSelectTeacher" class="form-control form-select">
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="selectClass" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Class
                    </label>
                    <select id="selectClass" class="form-control form-select">
            ...
            <div class="col-sm-6">
                <div class="">
                    <label for="selectRoom" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Room No
                    </label>
                    <select id="selectRoom" class="form-control form-select">
