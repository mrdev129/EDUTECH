  ...
  <div class="row align-items-center justify-content-between">
    ...
    <div class="dashboard-main-body">
        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                <h1 class="fw-semibold mb-4 h6 text-primary-light">Class Room List </h1>
                <div class="">
                    <a href="index.php" class="text-secondary-light hover-text-primary hover-underline">Dashboard </a>
                    <span class="text-secondary-light">/ Class Room List </span>
                </div>
            </div>
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionName" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Room
                        Name
                    </label>
                    <input type="text" class="form-control" id="sectionName" placeholder="Enter Class Room name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="subjectCode" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Capacity
                    </label>
                    <input type="text" class="form-control" id="subjectCode" placeholder="Enter room capacity">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
...
<div
    ...
    <form action="#" class="d-flex flex-column p-20">
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="">
                    <label for="sectionNameEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Subject
                        Name
                    </label>
                    <input type="text" class="form-control" id="sectionNameEdit" placeholder="Enter section name">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
                    <label for="subjectCodeEdit" class="text-sm fw-semibold text-primary-light d-inline-block mb-8">Capacity
                    </label>
                    <input type="text" class="form-control" id="subjectCodeEdit" placeholder="Enter room capacity">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="">
