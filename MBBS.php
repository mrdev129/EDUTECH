...
<div class="stream-content">
    ...
    <div class="course-image">
        <img id="courseImg" src="assets/images/courses/medicine.png" alt="MBBS General Medicine">
    </div>
    ...
    <p id="courseDesc" class="course-description">
        Deals with the prevention, diagnosis, and treatment of internal diseases in adults, focusing on comprehensive primary care and non-surgical management.
    </p>
...
<div class="stream-sidebar">
    ...
    <h4 class="sidebar-title">MBBS Specializations</h4>
<ul class="course-list">
    <li class="active" onclick="changeCourse('medicine', this)">General Medicine</li>
    <li onclick="changeCourse('surgery', this)">General Surgery</li>
    <li onclick="changeCourse('ortho', this)">Orthopedics</li>
    <li onclick="changeCourse('ent', this)">ENT</li>
    <li onclick="changeCourse('obgyn', this)">OB-GYN</li>
    <li onclick="changeCourse('pediatrics', this)">Pediatrics</li>
    <li onclick="changeCourse('derma', this)">Dermatology</li>
    <li onclick="changeCourse('psychiatry', this)">Psychiatry</li>
    <li onclick="changeCourse('radiology', this)">Radiology</li>
</ul>
...
const mbbsCourses = {
    surgery: {
        img: "assets/images/courses/surgery.png",
        title: "General Surgery",
        desc: "Focuses on abdominal contents, including the esophagus, stomach, small intestine, large intestine, liver, pancreas, and often the thyroid gland."
    },
    ortho: {
        img: "assets/images/courses/ortho.png",
        title: "Orthopedics",
        desc: "Dedicated to the diagnosis, treatment, and prevention of injuries and diseases of the body's musculoskeletal system, including bones and joints."
    },
    ent: {
        img: "assets/images/courses/ent.png",
        title: "ENT (Otolaryngology)",
        desc: "Specialized medical and surgical management and treatment of patients with diseases and disorders of the ear, nose, throat, and related structures."
    },
    obgyn: {
        img: "assets/images/courses/obgyn.png",
        title: "OB-GYN",
        desc: "Focuses on female reproductive health, pregnancy, and childbirth, combining medical and surgical care."
    },
    medicine: {
        img: "assets/images/courses/medicine.png",
        title: "General Medicine",
        desc: "Deals with the prevention, diagnosis, and treatment of internal diseases in adults, focusing on comprehensive primary care."
    },
    pediatrics: {
        img: "assets/images/courses/pediatrics.png",
        title: "Pediatrics",
        desc: "Specialized medical care for infants, children, and adolescents, focusing on physical, emotional, and social health."
    },
    derma: {
        img: "assets/images/courses/derma.png",
        title: "Dermatology",
        desc: "Focuses on conditions related to the skin, hair, and nails, ranging from cosmetic issues to skin cancer treatments."
    },
    psychiatry: {
        img: "assets/images/courses/psychiatry.png",
        title: "Psychiatry",
        desc: "Dedicated to the diagnosis, prevention, and treatment of mental, emotional, and behavioral disorders."
    },
    radiology: {
        img: "assets/images/courses/radiology.png",
        title: "Radiology",
        desc: "Uses medical imaging like X-rays, CT scans, and MRIs to diagnose and treat diseases seen within the body."
    }
};

// Update the function name or just keep it and change the reference
function changeCourse(courseKey, element) {
    const course = mbbsCourses[courseKey];
    if(!course) return;
