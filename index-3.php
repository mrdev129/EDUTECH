            ...
            <div class="menu-area menu-sticky">
                ...
                <div class="container custom-container">
                    <div class="rs-menu-area">
                        <div class="logo-area">
                            <a href="index.html">
                                <img src="assets/images/techzen_logo_home.png" alt="">
                        ...
                        <div class="rs-header-rightside">
                            <div class="main-menu hidden-md">
                                <ul class="nav-menu">
                                    <li class="has-clid relative">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="has-clid">
                                                <a class="active" href="#">Multipage <i class="fa fa-angle-down"></i></a>
                                                <ul class="sub-menu">
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="active" href="index-3.html">Home 03</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="has-clid">
                                                <a href="#">Onepage <i class="fa fa-angle-down"></i></a>
                                                <ul class="sub-menu">
                                                    <li>
                            ...
                            <div class="rs-header-contct">
                                <a href="tel:+85526691234"> <img src="assets/images/phone-call1.svg" alt=""> (+855) 2669 1234</a>
                            </div>
                            ...
                            <div class="header-btn">
                                <a class="main-btn" href="contact.html">Get a Quote <svg fill="#fff" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" width="24" height="24">
    ...
    <div class="offcanvas-menu">
        ...
        <div class="offcanvas-menu-inner">
            <div class="offc-logo mb-40">
                <a href="index-3.html"><img src="assets/images/techzen_logo_home.png" alt="Logo"></a>
            </div>
            <ul class="nav-menu">
                <li class="has-clid relative">
        ...
        <div class="rs-banner-slider">
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="rs-banner--inner-content">
                                    <h1 class="title" data-animation="fadeInDown" data-delay="0.1s">2024</h1>
                                    ...
                                    <h1 class="title-2" data-animation="fadeInLeft" data-delay="0.6s">Tech Solutions For <span class="color">Digital</span> Future</h1>
                                    ...
                                    <a data-animation="fadeInUp" data-delay="1.2s" class="main-btn" href="about.html">Get Started <i class="ri-arrow-right-fill"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="rs-banner__thumb" data-animation="fadeInUp" data-delay="1.5s">
                        <img src="assets/images/banner/man-standing-laptop2.png" alt="">
                    </div>
            ...
            <div class="items">
                <div class="rs-banner--slider-item">
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="rs-banner--inner-content">
                                    ...
                                    <h1 data-animation="fadeInLeft" data-delay="0.6s" class="title-2">Surfing The Waves of IT <span class="color">Innovation</span></h1>
                                    <p data-animation="fadeInLeft" data-delay="0.9s">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero soluta modi, libero, ratione quidem quibusdam ullam illo obcaecati </p>
                                    <a data-animation="fadeInUp" data-delay="1.2s" class="main-btn" href="about.html">Get Started <i class="ri-arrow-right-fill"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="rs-banner__thumb" data-animation="fadeInUp" data-delay="1.5s">
                        <img src="assets/images/banner/banner-lady.png" alt="">
                    </div>
                    <div class="rs-banner__shape1">
                        <img src="assets/images/banner/meter.png" alt="">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-service__item">
                        ...
                        <p>Podcasting Optonal Change Management Inside Of Workflows To Establish A Framework.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-service__item">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="rs-about__box">
                        ...
                        <h2 class="title split-in-fade">We provide perfect it <span>solutions & technology</span> for any startups.</h2>
                        ...
                        <ul>
                                ...
                                <div class="icon">
                                    <svg height="60" width="60" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 60 60" style="enable-background:new 0 0 60 60;" xml:space="preserve">
                                        ...
                                        <lineargradient id="SVGID_1_" gradientunits="userSpaceOnUse" x1="18" y1="29.6667" x2="42" y2="29.6667">
                                            <stop offset="0" style="stop-color:#4B63FC"></stop>
                                            <stop offset="1" style="stop-color:#B32AF3"></stop>
                                        </lineargradient>
                            ...
                            <li>
                                <div class="icon">
                                    <svg height="60" width="60" version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 60 60" style="enable-background:new 0 0 60 60;" xml:space="preserve">
                                        <style type="text/css">
                                            .st0 {
                                                opacity: 0.1;
                                                fill: #0C43FE;
                                        ...
                                        <path class="st0" d="M6,0h48c3.3,0,6,2.7,6,6v48c0,3.3-2.7,6-6,6H6c-3.3,0-6-2.7-6-6V6C0,2.7,2.7,0,6,0z"></path>
                                        <lineargradient id="SVGID_2_" gradientunits="userSpaceOnUse" x1="18" y1="29.6667" x2="42" y2="29.6667">
                                            <stop offset="0" style="stop-color:#4B63FC"></stop>
                                            <stop offset="1" style="stop-color:#B32AF3"></stop>
                                        </lineargradient>
                                        <path class="st1" d="M30,15l11,2.4c0.6,0.1,1,0.7,1,1.3v13.3c0,2.7-1.3,5.2-3.6,6.7L30,44.3l-8.4-5.6c-2.2-1.5-3.6-4-3.6-6.7V18.7
                        ...
                        <p>Rring to the table win-win survival strategies to ensure proactive domination. At the end of the day going forward.</p>
                        <a class="main-btn" href="about.html"> Discover More <i class="ri-arrow-right-fill"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="rs-section-title">
                        ...
                        <h2 class="title split-in-fade">We provide advanced <span class="color">solutions to growing</span> your online business.</h2>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-md-4">
                    <div class="rs-featured__item">
                        <div class="rs-featured__icon">
                            ...
                            <h4 class="title">App <br> Development</h4>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="rs-featured__item">
                        <div class="rs-featured__icon">
                            ...
                            <h4 class="title">Web <br> Development</h4>
                        </div>
                        <div class="rs-featured__list-box">
                            <ul>
                                <li>
                ...
                <div class="col-md-4">
                    <div class="rs-featured__item">
                        <div class="rs-featured__icon">
                            ...
                            <h4 class="title">Ecommerce <br> Development</h4>
                        </div>
                        <div class="rs-featured__list-box">
                            <ul>
                                <li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="rs-why-choose__thumb">
                        ...
                        <img class="item-2" src="assets/images/why-choose/why-choose-levft1.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="rs-why-choose__content">
                        <div class="rs-section-title black">
                            ...
                            <h2 class="title split-in-fade">Reasons to <span class="color">count</span> on us</h2>
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="rs-counter__item">
                        ...
                        <h4 class="title">Apps <br> Developed</h4>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="rs-counter__item">
                        ...
                        <h4 class="title">Web <br> Developed</h4>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="rs-counter__item">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="rs-counter__item">
                        ...
                        <h4 class="title">Data <br> Science</h4>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="rs-counter__item">
                        ...
                        <h4 class="title">Customer <br> Ratingsd</h4>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="rs-counter__item">
                        ...
                        <h4 class="title">Projects <br> Delivered</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="rs-section-title">
                        ...
                        <h2 class="title split-in-fade">Who we <span class="color">work</span> with</h2>
                        ...
                        <a class="main-btn" href="appointment.html">Let's Work Together <i class="ri-arrow-right-fill"></i></a>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="rs-cta__item-box">
                                    ...
                                    <div class="rs-cta__box">
                                        <div class="bg-icon" style="background-image: url(assets/images/cta/handshake2.png);"></div>
                                        <div class="icon">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="rs-cta__item-box">
                                    ...
                                    <div class="rs-cta__box">
                                        <div class="bg-icon" style="background-image: url(assets/images/cta/bar-chart2.png);"></div>
                                        <div class="icon">
                                            <img src="assets/images/cta/bar-chart2.png" alt="">
                                        </div>
                                        <h4 class="title"><a href="#">Small & Medium Business </a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="rs-cta__item-box">
                                    ...
                                    <div class="rs-cta__box">
                                        <div class="bg-icon" style="background-image: url(assets/images/cta/property2.png);"></div>
                                        <div class="icon">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="rs-cta__item-box">
                                    ...
                                    <div class="rs-cta__box">
                                        <div class="bg-icon" style="background-image: url(assets/images/cta/enterprise.png);"></div>
                                        <div class="icon">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="rs-section-title black">
                        ...
                        <h2 class="title split-in-fade">Process we <span class="color">follow</span></h2>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row align-items-center">
                <div class="col-lg-4">
                    <div class="rs-section-title">
                        ...
                        <h2 class="title split-in-fade">Our recent launched <span class="color">projects available</span> into market</h2>
                        <a class="main-btn" href="project.html">View All Projects <i class="ri-arrow-right-fill"></i></a>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="rs-case-study__slider">
                        <div class="rs-carousel owl-carousel nav-style1" data-loop="true" data-items="2" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="true" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="true" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="true" data-ipad-device-dots2="false" data-md-device="2" data-lg-device="2" data-md-device-nav="true" data-md-device-dots="false" data-doteach="false">
                            <div class="items">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="rs-section-title black">
                        ...
                        <h2 class="title split-in-fade">What Customers Said About Our Techzen</h2>
                    </div>
                </div>
                <div class="col-lg-3"></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="rs-section-title">
                        ...
                        <h2 class="title split-in-fade">Our experienced experts for your support</h2>
                    </div>
                </div>
                <div class="col-lg-3"></div>
            </div>
            <div class="rs-carousel owl-carousel rs-team__slider-box" data-loop="true" data-items="4" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="true" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="false" data-ipad-device="3" data-ipad-device-nav="true" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="true" data-ipad-device-dots2="false" data-md-device="3" data-lg-device="4" data-md-device-nav="true" data-md-device-dots="false" data-doteach="false">
                <div class="rs-team__single-item">
                    ...
                    <div class="content">
                        <a href="team-details.html">John Bradshaw</a>
                ...
                <div class="rs-team__single-item">
                    ...
                    <div class="content">
                        <a href="team-details.html">Nick Powel</a>
                        <span>Leader</span>
                    </div>
                </div>
                <div class="rs-team__single-item">
                    ...
                    <div class="content">
                        <a href="team-details.html">Elizabeth Layla</a>
                        <span>Designer</span>
                    </div>
                </div>
                <div class="rs-team__single-item">
                ...
                <div class="rs-team__single-item">
                    ...
                    <div class="content">
                        <a href="team-details.html">Patricia Gable</a>
                ...
                <div class="rs-team__single-item">
                    ...
                    <div class="content">
                        <a href="team-details.html">Amber Austin</a>
    ...
    <section id="rs-blog" class="rs-blog pb-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="rs-section-title black">
                        ...
                        <h2 class="title split-in-fade">Our insights on trends, Technologies and Transformation</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="rs-blog__single">
                        ...
                        <div class="content">
                            <div class="rs-blog-category">
                                <a href="#">
                                    <div class="icon"></div>Application
                                </a>
                            </div>
                            <h3 class="title">
                                <a href="blog-single.html">Tips to help you build your social media</a>
                            </h3>
                            <ul>
                                <li>Mar 16, 2023</li>
                                <li>
                                    <div class="rs-icon"></div> 8 min read
                                </li>
                            </ul>
                            ...
                            <div class="rs-blog-author">
                                ...
                                <div class="rs-link">
                                    <a href="blog-single.html">Read Post <i class="ri-arrow-right-fill"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="rs-blog__single">
                        ...
                        <div class="content">
                            <div class="rs-blog-category">
                                <a href="#">
                                    <div class="icon"></div> performance
                                </a>
                            </div>
                            <h3 class="title">
                                <a href="blog-single.html">Tips to help you build your social media</a>
            ...
            <div class="rs-blog__btn">
                <a class="main-btn" href="blog-standard.html">View All Blog <i class="ri-arrow-right-fill"></i></a>
            </div>
        </div>
    </section>
    <!--======== Blog Ends ========-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <button type="submit" class="main-btn">Send Message <i class="ri-arrow-right-fill"></i></button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="rs-footer__about-box">
                            ...
                            <div class="rs-btn">
                                <a class="main-btn" href="about.html"> Discover More <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" width="20" height="20">
                                        <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                                    </svg></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="rs-footer__navigation">
                            ...
                            <ul>
                                <li><a href="service-details.html">IT Solutions</a></li>
