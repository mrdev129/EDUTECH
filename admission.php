...
<head>
    ...
    <title>EDUTECH | ADMISSION FORM</title>
...
<body class="home-page-2">
            ...
            <div class="menu-area menu-sticky">
                ...
                <div class="container">
                    <div class="rs-menu-area">
                        <div class="logo-area">
                            <a href="index.html"><img src="assets/images/cliet_logo.PNG" alt="logo"></a>
                            <a href="index.html"><img src="assets/images/cliet_logo.png" alt=""></a>
                        </div>
                        <div class="rs-header-rightside">
                            <div class="main-menu hidden-md">
                                <ul class="nav-menu"> 
                                    <li>
                                        <a class="page-scroll" href="onepage.html#rs-header">Home</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="onepage.html#rs-about">About</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="onepage.html#rs-service">Services</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="onepage.html#rs-portfolios">Portfolios</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="onepage.html#rs-blog">Blog</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="onepage.html#rs-contact">Contact</a>
                                    </li>
                                </ul> <!-- //.nav-menu -->
                            </div> <!-- //.main-menu -->
    ...
    <section class="rs-admission-form pt-120 pb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rs-section-title black text-center">
                        ...
                        <h2 class="title split-in-fade">Apply for Admission</h2>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="rs-admission-form__box">
                        <form action="#" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="main-btn">Submit Application <i class="ri-arrow-right-fill"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
