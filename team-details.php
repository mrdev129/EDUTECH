...
<body class="team-details-page">
                                ...
                                <ul class="nav-menu">
                                    ...
                                    <li class="has-clid relative">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                <a class="active" href="team-details.html">Team Details</a>
                                            </li>
                                            <li>
    ...
    <!--======== Team Details Page Banner Start ========-->
                ...
                <div class="col-lg-12">
                    <div class="rs-page-banner__content">
                        ...
                        <ul>
                            ...
                            <li><i class="ri-arrow-right-fill"></i> Team Details</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!--======== Team Details Page Banner Ends ========-->

    <!--======== Team Details Start ========-->
    <section class="rs-team-details pt-120 pb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="rs-team-details__sidebar">
                        <div class="rs-thumb">
                            <img src="assets/images/team/team-sidebar-1.jpg" alt="">
                            <div class="rs-shape-1">
                                <img src="assets/images/team/rect.svg" alt="">
                            </div>
                            <div class="rs-shape-2">
                                <img src="assets/images/team/shape-item.png" alt="">
                            </div>
                        </div>
                        <div class="rs-content">
                            <h3 class="title">Elizabeth Layla</h3>
                            <span>Designer</span>
                            <ul>
                                <li><span class="sub">Department:</span> <span>Web Development</span></li>
                                <li><span class="sub">Experience:</span> <span>10 Years</span></li>
                                <li><span class="sub">Email:</span> <a href="mailto:info@gmail.com">info@gmail.com </a></li>
                                <li><span class="sub">Phone:</span> <a href="tel:+91123456789"> +91 123 456 789 </a></li>
                            </ul>
                            <div class="rs-social">
                ...
                <div class="col-lg-7">
                    <div class="rs-team-details__content">
                        <div class="rs-content mb-35">
                        ...
                        <div class="rs-content mb-35">
                            <h3 class="title">Career Guidelines</h3>
                        ...
                        <div class="rs-team-details__contact mt-50">
