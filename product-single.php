...
<body class="product-single-page">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="has-clid">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li>
                                                        <a class="active" href="product-single.html">Product Single</a>
                                                    </li>
                                                    <li>
    ...
    <!--======== Shop Single Page Banner Start ========-->
    <section class="rs-page-banner">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rs-page-banner__content">
                        <h1 class="title">Product Single</h1>
                        <ul>
                            <li><i class="ri-home-wifi-line"></i> <a href="#">Home</a></li>
                            <li><i class="ri-arrow-right-fill"></i>Product Single</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!--======== Shop Single Page Banner Ends ========-->

    <!--======== Shop Single Start ========-->
    <section class="rs-shop-single pt-120">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="rs-shop-single__content">
                        <h3 class="title">Purifier Sharp</h3>
                        <span class="rs-price">$22.00</span>
                        <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        <div class="rs-shop-btns">
                            <form action="#">
                                <input type="number" value="1">
                                <button class="main-btn" type="submit">Add to cart</button>
                            </form>
                        </div>
    ...
    <div class="rs-shop-dec pt-60 pb-60">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rs-shop-dec__tabs">
                        <div id="rs-tabs" class="skltbs-theme-light use-drop skltbs-mode-tabs skltbs-init">
                            ...
                            <ul class="skltbs-tab-group">
                                ...
                                <li class="skltbs-tab-item">
                                    <button class="skltbs-tab"> Reviews (0) </button>
                                </li>
                            </ul>
                            <!-- panelGroup -->
    ...
    <section class="rs-related-product pb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="rs-shop-item mt-30">
                        <div class="rs-thumb">
                            <a href="product-single.html">
                                <img src="assets/images/shop/standaed-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="rs-shop-item mt-30">
                        <div class="rs-thumb">
                            <a href="product-single.html">
                                <img src="assets/images/shop/standaed-2.jpg" alt="">
                                <span class="rs-add-cart">Add To Cart</span>
                            </a>
                        </div>
                        <div class="rs-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="rs-shop-item mt-30">
                        <div class="rs-thumb">
                            <a href="product-single.html">
                                <img src="assets/images/shop/standaed-3.jpg" alt="">
                                <span class="rs-add-cart">Add To Cart</span>
                            </a>
                        </div>
                        <div class="rs-content">
                            <a href="product-single.html">White Headphone</a>
                            <h5 class="rs-price">$29.00</h5>
                        </div>
                    </div>
                </div>
