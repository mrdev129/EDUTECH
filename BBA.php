...
<div class="stream-content">
    <div class="course-image">
        <img id="courseImg" src="assets/images/courses/finance.png" alt="BBA Finance">
    </div>
    ...
    <p id="courseDesc" class="course-description">
        Focuses on investment management, corporate finance, banking, financial modeling, and international accounting standards.
    </p>
</div>
...
<div class="stream-sidebar">
    ...
    <ul class="course-list">
        ...
        <li onclick="changeCourse('hr', this)">Human Resources</li>
        <li onclick="changeCourse('ib', this)">International Business</li>
        <li onclick="changeCourse('analytics', this)">Business Analytics</li>
...
const bbaCourses = {
    finance: {
        img: "assets/images/courses/finance.png",
        title: "BBA in Finance",
        desc: "Focuses on investment management, corporate finance, banking, financial modeling, and international accounting standards."
    },
    marketing: {
        img: "assets/images/courses/marketing.png",
        title: "BBA in Marketing",
        desc: "Covers consumer behavior, digital marketing strategies, brand management, market research, and advertising."
    },
    hr: {
        img: "assets/images/courses/hr.png",
        title: "BBA in Human Resources (HR)",
        desc: "Deals with talent acquisition, employee relations, performance management, organizational behavior, and labor laws."
    },
    ib: {
        img: "assets/images/courses/ib.png",
        title: "BBA in International Business",
        desc: "Focuses on global trade, international logistics, cross-cultural management, and foreign exchange markets."
    },
    analytics: {
        img: "assets/images/courses/analytics.png",
        title: "BBA in Business Analytics",
        desc: "Combines data science with business strategy, focusing on data visualization, predictive modeling, and statistical analysis."
    },
    retail: {
        img: "assets/images/courses/retail.png",
        title: "BBA in Retail Management",
        desc: "Covers supply chain management, store operations, inventory control, and customer relationship management in the retail sector."
    }
};

function changeCourse(courseKey, element){
    const course = bbaCourses[courseKey];
    if(!course) return;
