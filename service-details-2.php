...
<body class="service-details-2">
                            ...
                            <div class="main-menu hidden-md">
                                <ul class="nav-menu">
                                    <li class="has-clid relative">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="has-clid">
                                                <a href="index.html">Multipage <i class="fa fa-angle-down"></i></a>
                                                <ul class="sub-menu">
                                                    <li>
                                            ...
                                            <li class="has-clid">
                                                <a href="onepage-2.html">Onepage <i class="fa fa-angle-down"></i></a>
                                                <ul class="sub-menu">
                                                    <li>
                                    ...
                                    <li class="has-clid relative">
                                        <a class="active" href="service-1.html">
                                            <cite class="rs_item_wrap">
                                                Services
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="has-clid">
                                                <a class="active" href="service-details.html">Service Details <i class="fa fa-angle-down"></i></a>
                                                <ul class="sub-menu">
                                                    <li>
                                                        <a href="service-details.html">Service Details Style 01</a>
                                                    </li>
                                                    <li>
                                                        <a class="active" href="service-details-2.html">Service Details Style 02</a>
                                                    </li>
                                                    <li>
            ...
            <ul class="nav-menu">
                <li class="has-clid relative">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="has-clid">
                            <a href="onepage-2.html">Onepage</a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="onepage.html">Onepage 01</a>
                                </li>
    ...
    <!--======== Service Details Page Banner 2 Start ========-->
    <section class="rs-page-banner">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rs-page-banner__content">
                        <h1 class="title">Service Detail Style2</h1>
                        <ul>
                            <li><i class="ri-home-wifi-line"></i> <a href="#">Home</a></li>
                            <li><i class="ri-arrow-right-fill"></i> Service Detail Style2</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!--======== Service Details Page Banner 2 Ends ========-->

    <!--======== Service Details 2 Start ========-->
    <section class="rs-service-details-about pt-120 pb-145">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="rs-section-title black">
                        ...
                        <h2 class="title split-in-fade">We Help to Implement Your Ideas into Automation</h2>
                        <p class="mb-20">We donec pulvinar magna id leoersi pellentesque impered dignissim rhoncus euismod euismod eros vitae best consulting & financial services theme .</p>
                        ...
                        <a href="contact.html" class="main-btn mt-40"> Contact Us <i class="ri-arrow-right-fill"></i></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="rs-thumb">
                        <img src="assets/images/faq/faq-left-img.png" alt="">
                        <div class="rs-shape">
                            <img src="assets/images/faq/couple-ball-layer.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--======== Service Details 2 Ends ========-->

    <!--======== Service Details Features Start ========-->
    <section class="rs-service-details-features pb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="rs-service-details-features__item">
                        <div class="icon">
                            <img src="assets/images/service/repair-expesrt.png" alt="">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="rs-service-details-features__item">
                        <div class="icon">
                            <img src="assets/images/service/bar-charat.png" alt="">
                        </div>
                        <h5 class="title">First Growing Process</h5>
                        <p> At vero eos et accusamus etiusto odio praesentium.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="rs-service-details-features__item">
                        <div class="icon">
                            <img src="assets/images/service/ideaa.png" alt="">
                        </div>
    ...
    <!--======== Service Details Features Ends ========-->

    <!--======== Service Details Why Choose Start ========-->
    <section class="rs-service-details-why-Choose pt-120 pb-120">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="rs-service-details-why-Choose__thumb">
                ...
                <div class="col-lg-6">
                    <div class="rs-section-title black">
                        ...
                        <h2 class="title split-in-fade">We Worked With Reputed Companies in The World</h2>
                        <p class="mb-20">We donec pulvinar magna id leoersi pellentesque impered dignissim rhoncus euismod euismod eros vitae.</p>
                    </div>
                    <div class="rs-service-details-why-Choose__skill">
                        <div class="skill-bars">
                            ...
                            <div class="rs-progress-skill why-choose-two__progress">
                                <h4 class="rs-progress__title">Web Development</h4>
                                <div class="rs-progress__bar">
                            ...
                            <div class="rs-progress-skill why-choose-two__progress">
                                <h4 class="rs-progress__title">SEO Analysis</h4>
                                <div class="rs-progress__bar">
    ...
    <!--======== Service Details Why Choose Ends ========-->

    <!--======== Service Details Counter Start ========-->
    <section class="rs-service-details-counter">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="rs-service-details-counter__item">
                        <h3 class="title"> <span class="odometer" data-count="100">00</span> <sub>k</sub></h3>
                        <span> Happy Clients</span>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="rs-service-details-counter__item">
                        <h3 class="title"> <span class="odometer" data-count="250">00</span> <sub>+</sub></h3>
                        <span>Projects Done</span>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="rs-service-details-counter__item">
                        <h3 class="title"> <span class="odometer" data-count="60">00</span> <sub>+</sub></h3>
    ...
    <!--======== Service Details Counter Ends ========-->

    <!--======== Service Details Pricing Start ========-->
    <section class="rs-service-details-pricing pt-110 pb-50">
        <div class="container custom-container-2">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rs-section-title black">
                        ...
                        <h2 class="title split-in-fade">Our Pricing Plan</h2>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="rs-service-details-pricing__item mt-30">
                        <div class="rs-batch">
                            <span>Silver</span>
                        </div>
                        <div class="rs-icon">
                            <img src="assets/images/service/price-icon-1.png" alt="">
                        </div>
                        <div class="pricing-content">
                            <h3 class="title"><span>$</span>29.99</h3>
                            <span>Monthly Package</span>
                            <ul>
                                <li>Powerful Admin Panel <i class="ri-check-fill"></i></li>
                                <li>1 Native Android App <i class="ri-check-fill"></i></li>
                                <li>Multi-Language Support <i class="ri-close-fill"></i></li>
                                <li>Support via E-mail and Phone <i class="ri-close-fill"></i></li>
                            </ul>
                            <a class="main-btn" href="contact.html">Buy Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="rs-service-details-pricing__item item-2 mt-30">
                        <div class="rs-batch">
                            <span>Gold</span>
                        </div>
                        <div class="rs-icon">
                            <img src="assets/images/service/price-icon-2.png" alt="">
                        </div>
                        <div class="pricing-content">
                            <h3 class="title"><span>$</span>39.99</h3>
                            <span>Monthly Package</span>
                            <ul>
                                <li>Powerful Admin Panel <i class="ri-check-fill"></i></li>
                                <li>1 Native Android App <i class="ri-check-fill"></i></li>
                ...
                <div class="col-lg-4">
                    <div class="rs-service-details-pricing__item mt-30">
                        ...
                        <div class="rs-icon">
                            <img src="assets/images/service/price-icon-3.png" alt="">
                        </div>
                        <div class="pricing-content">
                            <h3 class="title"><span>$</span>79.99</h3>
                            <span>Monthly Package</span>
                            <ul>
                                <li>Powerful Admin Panel <i class="ri-check-fill"></i></li>
                                <li>1 Native Android App <i class="ri-check-fill"></i></li>
    ...
    <!--======== Service Details Pricing Ends ========-->

    <!--======== Service Details Brand Start ========-->
    <div class="rs-brand service-brand pb-85 pt-85">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
