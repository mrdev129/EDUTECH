...
<head>
    ...
    <style>
        ...
        /* Offset for the sticky menu so it doesn't cover section titles */
        section {
            scroll-margin-top: 80px;
        }

        /* 1. Header Styling - Separated with Bends */
        .edutech-main-header {
            background: var(--edutech-navy);
            padding: 15px 0;
        ...
        .enquiry-top-btn {
            background: var(--edutech-yellow);
            color: var(--edutech-navy);
            padding: 10px 25px;
            border-radius: 50px;
            font-weight: 800;
            text-decoration: none;
        ...
        /* 2. Announcement Bar - Separated with Bends */
        .static-announcement {
            background: var(--edutech-yellow);
            text-align: center;
            padding: 10px 0;
            margin: 10px 15px 0 15px;
            /* Margin top creates the gap */
            border-radius: 15px;
            /* Bent corners */
            font-weight: 700;
            color: var(--edutech-navy);
        ...
        /* 3. Hero Section - Separated with Bends */
        .split-hero {
            min-height: 85vh;
            padding: 60px 0;
            position: relative;
        ...
        /* Ensure each slider item has a full height */
        /* Ensure the main slider container is clean */
        ...
        /* Each item carries its own blue filter */
        .hero-bg-slider .item {
            height: 100vh;
            width: 100%;
        ...
        /* This is the blue 'glass' over the photo */
        .hero-bg-slider .item::after {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
        ...
        .compact-form {
            ...
            background: #ffffff;
            border-radius: 20px;
            /* Bends for form corner */
            padding: 30px !important;
        }

        .hero-submit-btn {
            background: var(--edutech-orange);
            color: white;
            padding: 14px;
            border-radius: 8px;
            font-weight: 800;
        ...
        /* 4. Sliding Message Bar - Lowest and Separate */
        .sliding-info-bar {
            background: var(--edutech-navy);
            color: white;
            padding: 12px 0;
            margin: 10px 15px;
            /* Gap created by margin */
            border-radius: 15px;
            /* Bent corners */
            font-weight: 500;
            position: relative;
        ...
        .service-slider-bottom .owl-nav button {
            background: none !important;
            color: var(--edutech-navy) !important;
            font-weight: bold;
            font-size: 16px;
        }
        ...
        @media (max-width: 991px) {
            .program-menu {
                display: none;
                /* Hide full menu on mobile or use a toggle */
            }
        }
    </style>
</head>
    ...
    <div class="header-announcement-wrapper">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="hero-content-left text-white">
                            ...
                            <a href="#" class="brochure-btn btn btn-warning rounded-pill px-4">DOWNLOAD BROCHURE <i class="ri-arrow-down-line"></i></a>
                        </div>
                    </div>
        ...
        <div class="sliding-info-bar">
            <marquee behavior="scroll" direction="left" scrollamount="7">
                Official website of EDUTECH University Online. | Secure & Confidential: only through the secure link on this safe us. | Admissions for 2026 are now open! Apply Today.
            </marquee>
        </div>
        </section>
    ...
    ======== Offcanvas Menu Ends ======== -->
        ...
        <div class="rs-service-2 pt-90 pb-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rs-carousel owl-carousel service-slider-bottom"
                            data-loop="true"
                            data-items="5"
                            data-margin="30"
                            data-autoplay="true"
