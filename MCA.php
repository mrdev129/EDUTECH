...
<div class="stream-content">
    ...
    <div class="course-image">
        <img id="courseImg" src="assets/images/courses/mca-software.png" alt="">
    </div>
    ...
    <p id="courseDesc" class="course-description">
        Focuses on advanced programming, software engineering, database management and modern application development.
    </p>
...
<div class="stream-sidebar">
    ...
    <h4 class="sidebar-title">MCA Specializations</h4>

    <ul class="course-list">
        <li class="active" onclick="changeCourse('software',this)">Software Development</li>
        <li onclick="changeCourse('datascience',this)">Data Science</li>
        <li onclick="changeCourse('ai',this)">Artificial Intelligence</li>
        <li onclick="changeCourse('cybersecurity',this)">Cyber Security</li>
        <li onclick="changeCourse('cloud',this)">Cloud Computing</li>
        <li onclick="changeCourse('mobile',this)">Mobile App Development</li>
        <li onclick="changeCourse('web',this)">Web Development</li>
        <li onclick="changeCourse('blockchain',this)">Blockchain Technology</li>
    </ul>
...
const mcaCourses = {
    ...
    software:{
        img:"assets/images/courses/mca-software.png",
        title:"MCA in Software Development",
        desc:"Focuses on advanced programming, full-stack development, software architecture and enterprise application systems."
    },

    datascience:{
        img:"assets/images/courses/mca-datascience.png",
        title:"MCA in Data Science",
        desc:"Covers big data analytics, machine learning, statistical modeling and business intelligence tools."
    },

    ai:{
        img:"assets/images/courses/mca-ai.png",
        title:"MCA in Artificial Intelligence",
        desc:"Focuses on neural networks, deep learning, computer vision and intelligent automation systems."
    },

    cybersecurity:{
        img:"assets/images/courses/mca-cyber.png",
        title:"MCA in Cyber Security",
        desc:"Covers ethical hacking, digital forensics, network security and cyber threat management."
    },

    cloud:{
        img:"assets/images/courses/mca-cloud.png",
        title:"MCA in Cloud Computing",
        desc:"Focuses on AWS, Azure, cloud infrastructure, DevOps and scalable distributed systems."
    },

    mobile:{
        img:"assets/images/courses/mca-mobile.png",
        title:"MCA in Mobile App Development",
        desc:"Covers Android, iOS, Flutter, React Native and cross-platform mobile application development."
    },

    web:{
        img:"assets/images/courses/mca-web.png",
        title:"MCA in Web Development",
        desc:"Focuses on modern frontend and backend technologies including React, Node.js, Laravel and API integration."
    },

    blockchain:{
        img:"assets/images/courses/mca-blockchain.png",
        title:"MCA in Blockchain Technology",
        desc:"Covers smart contracts, decentralized applications (DApps), cryptocurrency systems and Web3 technologies."
    }
...
function changeCourse(courseKey, element){
    ...
    const course = mcaCourses[courseKey];
    if(!course) return;
