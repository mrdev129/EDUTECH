...
<body class="service-page-2">
                                ...
                                <ul class="nav-menu">
                                    ...
                                    <li class="has-clid relative">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                <a class="active" href="service-2.html">Service Style 02</a>
                                            </li>
                                            <li class="has-clid">
    ...
    <!--======== Service Page Banner 2 Ends ========-->

    <!--======== Service Grid 2 Start ========-->
    <section class="rs-service-3 rs-service-grid-2 pt-90 pb-120">
        <div class="container">
            <div class="row">
    ...
    <!--======== Service Why Choose 2 Start ========-->
    <section class="rs-why-choose rs-why-choose-4 service-why-choose pt-120 pb-85">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="rs-why-choose-4__thumb">
                        <div class="rs-thumb-1">
                            <img src="assets/images/why-choose/chose-right-left.jpg" alt="">
                        </div>
                        <div class="rs-thumb-2">
                            <img src="assets/images/why-choose/choose-image.jpg" alt="">
                ...
                <div class="col-lg-6">
                    <div class="rs-why-choose__content">
                        <div class="section-title-2 section-title-3 black">
                        ...
                        <div class="rs-why-choose__item-list">
                            <ul>
                                <li>
                                    <div class="thumb">
                                        <img src="assets/images/why-choose/ch-1.png" alt="">
                                    </div>
                                    <div class="content">
                                ...
                                <li>
                                    <div class="thumb">
                                        <img src="assets/images/why-choose/ch-2.png" alt="">
                                    </div>
                                    <div class="content">
                                ...
                                <li>
                                    <div class="thumb">
                                        <img src="assets/images/why-choose/ch-3.png" alt="">
                                    </div>
                                    <div class="content">
                                        <h4 class="title">Well Documentation</h4>
    ...
    <!--======== Service Why Choose 2 Ends ========-->

    <!--======== Service Testimonial Start ========-->
    <section class="rs-testimonial service-testimonial pt-110 pb-115">
        <div class="container">
            <div class="row">
    ...
    <!--======== Service Testimonial Ends ========-->

    <!--======== Service Brand Start ========-->
    <div class="rs-brand service-brand pb-80 pt-115">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <section class="rs-pricing  pt-0 pb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rs-section-title black">
