                                ...
                                <ul class="nav-menu">
                                    ...
                                    <li class="has-clid relative">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                <a class="active" href="project-details.html">Project Details</a>
                                            </li>
                                            <li>
                ...
                <div class="col-lg-8">
                    <div class="rs-project-details__content mt-30 ">
                        ...
                        <div class="rs-project-content">
                            ...
                            <p>Completely synergize resource taxing relationships via premier niche markets. Professionally cultivate one-to-one customer service with robust ideas. Dynamically</p>
                            <p>service for state of the art customer service. Objectively innovate empowered manufactured products whereas parallel platforms.</p>
                            ...
                            <div class="rs-project-sourc">
                                ...
                                <div class="rs-project-sourc-box">
                                    ...
                                    <div class="rs-project-list">
                                        ...
                                        <ul>
                                            <li><i class="ri-checkbox-circle-line"></i> Provided Professional and Certified</li>
                            ...
                            <div class="rs-project-bar">
                                ...
                                <div class="rs-project-switch-btn">
                                    <ul>
                                        <li><a class="main-btn" href="#"><i class="ri-arrow-left-fill"></i> Prev Post</a></li>
                                        <li><a class="main-btn" href="#">Next Post <i class="ri-arrow-right-fill"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="rs-project-cta-box pt-80 pb-90">
                        <div class="rs-project-cta__content">
                            ...
                            <a class="main-btn" href="contact.html">Contact With Us <i class="ri-arrow-right-fill"></i></a>
                        </div>
                        <div class="rs-thumb">
